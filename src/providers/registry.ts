...
import { edgeProvider } from './edge/server.ts'
import type { SpeechProvider, SpeechProviderId } from './types.ts'

/** Every provider this host can call, in display order. */
export const PROVIDERS: readonly SpeechProvider[] = Object.freeze([edgeProvider])
 ...
 */
export function providerById(id: SpeechProviderId): SpeechProvider | undefined {
