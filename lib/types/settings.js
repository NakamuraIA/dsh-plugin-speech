 ...
 */
export const SPEECH_PROVIDERS = ['edge'];
...
export const DEFAULT_EDGE_SETTINGS = Object.freeze({
 ...
 */
export function isSpeechProvider(value) {
 ...
 */
export function activeVoiceSettings(section) {
 ...
 */
export function activeBlockField() {
